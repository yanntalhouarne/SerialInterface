...
#include <memory>
#include "../../SerialInterfaceGUI/downloadmanager.h"
...
QT_MOC_LITERAL(3, 32, 16) // "downloadFinished"
    ...
    "downloadManager\0finishedSignal\0\0"
    "downloadFinished"
};
...
void downloadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&downloadManager::finishedSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void downloadManager::finishedSignal()
{
